export enum PageId {
  MainPage = 'main',
  PageActionSetA = 'action-set-a',
  PageActionSetB = 'action-set-b',
  PageAnimalSetA = 'animal-set-a',
  PageAnimalSetB = 'animal-set-b',
  PageClothes = 'clothes',
  PageEmotions = 'emotions',
  PageProfessions = 'professions',
  PageWeather = 'weather',
}
...
export const Links = [
  ...
  {
    id: PageId.PageActionSetA,
    text: 'Action (set A)',
  },
  {
    id: PageId.PageActionSetB,
    text: 'Action (set B)',
  },
  {
    id: PageId.PageAnimalSetA,
    text: 'Animal (set A)',
  },
  {
    id: PageId.PageAnimalSetB,
    text: 'Animal (set B)',
  },
  {
    id: PageId.PageClothes,
    text: 'Clothes',
  },
  {
    id: PageId.PageEmotions,
    text: 'Emotions',
  },
  {
    id: PageId.PageProfessions,
    text: 'Professions',
  },
  {
    id: PageId.PageWeather,
    text: 'Weather',
  },
  {
    id: PageId.MainPage,
